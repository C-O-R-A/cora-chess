...
def expand_tensor(board_tensor, extra_data):
    '''
    board_tensor: (6, 8, 8)
    extra_data: list or np array of extra features
    returns: dict with both
    '''
    extra_tensor = torch.tensor(extra_data, dtype=torch.float)
    board_tensor = torch.tensor(board_tensor, dtype=torch.float)
